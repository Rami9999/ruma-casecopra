...
export default function Home() {
  return (
    <div className="bg-slate-50 ">
        ...
        lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            lg:text-left flex flex-col items-center lg:items-start">
                ...
                text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                  Your Image on a{' '}
                   ...
                   <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                    ...
                    <span className="font-semibold"> one-of-one </span>
                     phone case. CaseCobra allows you to protect your memories not, not just your phone.
                   </p>
                   <ul className="mt-10 space-y-2 text-left font-medium 
                   ...
                   items-center sm:items-start gap-5">
                      ...
                      <div className="flex flex-col justify-between items-center sm:items-start">
                        ...
                        <p> 
                          <span className="font-semibold">2.850</span> happy customers 
                        </p>
                      </div>
                   </div>
            </div>
      ...
      {/* value propoistion section */}

      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
            <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
                <h2 className="order-1 mt-2 tracking-tight text-balance text-center
                !leading-tight font-bold text-5xl sm:text-6xl text-gray-900 ">
                  What our <span className="relative px-2">customers {' '}
                     <Icons.underline  className="hiddent sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500"/>
                   </span> {' '}
                   say
                </h2>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
              <div className="flex flex-autp flex-col gap-4 lg:pr-8 xl:pr-20">
